 ...
 * and error handling.
 */
export function EncryptButton({ value, publicKey, contractAddress: _contractAddress, onEncrypted, onError, children, buttonProps = {} }) {
    ...
    return (_jsxs("button", { ...buttonProps, onClick: handleEncrypt, disabled: !instance || isEncrypting, style: {
            opacity: !instance || isEncrypting ? 0.6 : 1,
            cursor: !instance || isEncrypting ? "not-allowed" : "pointer",
            ...buttonProps.style
        }, children: [isEncrypting ? "Encrypting..." : children, error && (_jsx("div", { style: { color: "red", fontSize: "0.8em", marginTop: "4px" }, children: error.message }))] }));
}
//# sourceMappingURL=EncryptButton.js.map